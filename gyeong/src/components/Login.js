    ...
    return (
        <div>
            <div className="adress_table"style={{border: '1px solid gray', padding:'7px 15px'}}>
                <div className="background2" data-aos="fade-up">
                    ...
                    <div className="adress_text">
                        *주소<br></br>
                        <Input type="text" className="adr1" id="memberAdr1" placeholder="우편번호"/><br/>
                    ...
                    <div>
                        <Button className="Adress_btn" id="id_btn" type="button" variant="light" size="lg-3  " 
            ...
            <div className="login_table"style={{border: '1px solid gray', padding:'7px 15px'}}>
                <div className="background1" data-aos="zoom-in">
                    ...
                    <div>
                        <Button className="Login_btn" id="id_btn" type="button" variant="light" size="lg-3  " 
