...
const Gat_home = () => {
    ...
    const get_mygat = async () => {
        ...
        .then(res => {
            for (let i = 0; i < res.data.length; i++) {
                $(".gh_mygat_list").append("<li id='li"+ i +"'>"+res.data[i].GAT_TITLE+"</li>");
            }
            setGatToggle(true);
        });
    }
    ...
    const toggle_mygat = () => {
        if ($("#li0").css("display") == 'list-item') {
            ...
            $("#li0").css("display","list-item");
            $("#li1").css("display","list-item");
            $("#li2").css("display","list-item");
        }
    }
                        ...
                        <div className='gh_item_area'>
                            <div className='gh_res_item' id='gh_item1'>
                                ...
                                <div className='gh_res_btArea'>
                                    <button className='gh_res_bt'>보기</button>
                                </div>
                            </div>
